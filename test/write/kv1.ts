...
describe('Writing to a KV Version 1 Engine Path', function() {
                        ...
                        context('when writing a new secret', function() {
                            ...
                            describe('write valid key/value data', function() {
                                ...
                                it('prepopulates the path', async function() {
                                    expect(await input.getText()).to.equal(constants.WRITE_KV1_FULL_PATH);
                                });
                                ...
                                context('when a child path is provided', function() {
                                    ...
                                    before(async function() {
                                        await input.setText(constants.WRITE_KV1_FULL_PATH + childPath);
                                        await input.confirm();
                                    });
